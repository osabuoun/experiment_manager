...
queries = [
	...
	{'var': "jqueuer_task_running_count", 				'query_str': "count(jqueuer_task_running_count)+by+(experiment_id,service_name)" },
	{'var': "jqueuer_task_started_count", 				'query_str': "count(jqueuer_task_started_count)+by+(experiment_id,service_name)" },
	{'var': "jqueuer_task_accomplished_count", 			'query_str': "count(jqueuer_task_accomplished_count)+by+(experiment_id,service_name)" },
	...
	{'var': "jqueuer_job_running_count", 				'query_str': "count(jqueuer_job_running_count)+by+(experiment_id,service_name)" },
	{'var': "jqueuer_job_started_count", 				'query_str': "count(jqueuer_job_started_count)+by+(experiment_id,service_name)" },
	{'var': "jqueuer_job_accomplished_count", 			'query_str': "count(jqueuer_job_accomplished_count)+by+(experiment_id,service_name)" },
	...
	{'var': "jqueuer_job_failed_count", 				'query_str': "count(jqueuer_job_failed_count)+by+(experiment_id,service_name)" },
